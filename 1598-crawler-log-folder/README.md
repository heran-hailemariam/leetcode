<h2><a href="https://leetcode.com/problems/design-parking-system/description/">1720. Crawler Log Folder</a></h2><h3>Easy</h3><hr><p>The Leetcode file system keeps a log each time some user performs a <em>change folder</em> operation.</p>
